...
- **Local-only proxy** — binds to `127.0.0.1`, nothing exposed externally; one proxy per pi/OMP process, shared by every session in it (including in-process subagents)
